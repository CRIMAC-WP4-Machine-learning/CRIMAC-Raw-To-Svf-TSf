...
# =============================================================================
tmp = lsss.get('/lsss/data/ping', params={'pingNumber':pingNo,
...
lsss.post('/lsss/module/BroadbandTsModule/enabled', json={'value':True})  # Just make sure the BB Sv(f) window is active
BroadbandTS= lsss.get('/lsss/module/BroadbandTsModule/data')

# =============================================================================
# ##### Sv values - read from LSSS value in ping between minDepth, maxDepth
# =============================================================================
Sv = lsss.get('/lsss/data/ping', params={'pingNumber':pingNo,
                                        'minDepth': minDepth, 'maxDepth': maxDepth,
                                        'sv': True})
##### Pulse compressed values - read from LSSS
PC = lsss.get('/lsss/data/ping', params={'pingNumber':pingNo,
                                        'minDepth': minDepth, 'maxDepth': maxDepth,
                                         'pulseCompressed': True})

##### TSc values - read from LSSS
TSc = lsss.get('/lsss/data/ping', params={'pingNumber':pingNo,
                                        'minDepth': minDepth, 'maxDepth': maxDepth,
                                         'tsc': True})
#### Complex values - pre PC
PPC = lsss.get('/lsss/data/ping', params={'pingNumber':pingNo,
                                        'minDepth': minDepth, 'maxDepth': maxDepth,
                                         'complex': True})
