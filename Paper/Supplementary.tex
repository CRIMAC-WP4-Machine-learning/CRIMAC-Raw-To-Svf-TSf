...
$\hbp(\genidxsym,\stagesym)$ & & 1 & Complex valued receiving filter coefficients.\\
...
$\sv(\samplesymt)$ & & dB re 1 $\textrm{m}^{-1}$ & Volume backscattering strength at sample index $\samplesymt$.\\
