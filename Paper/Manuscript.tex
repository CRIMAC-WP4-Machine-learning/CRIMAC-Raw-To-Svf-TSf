...
Lars: The peak in the send pulse needs to match with the peak in the signal.
...
\caption{\label{fi:SED} The power (upper) and split beam angles (lower) for the single target. The vertical line corresponds to the range and angles for the single target.}
\end{figure}
...
%
\begin{figure}
\includegraphics[width=16cm]{Fig_normalizedDFT}
...
Usikker på om vi skal bruka indeksar eller variablar for gain.
