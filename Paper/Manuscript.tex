...
\caption{\label{fi:ytx} Ideal and enveloped transmit pulse between 34 kHz to 45 kHz with a slope of 0.057, as implemented in the EK80. The orange curve illustrates the effect of setting the slope to 0.5.}
\end{figure}
...
As a metallic sphere is a rather simple and ideal scatterer, we use $\sv$ from a school of non-swimbladdered fish (fig.~\ref{Fig_Sv_echogram}) collected with a 120 kHz centre frequency transducer to illustrate the processes to obtain $S_v(m)$. 
