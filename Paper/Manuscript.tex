...
\caption{\label{fi:SED} The \prxe(\samplesymt) power (upper) and split beam angles ($\along_t$ and $\athw_t$) (lower) for the single target. The vertical line corresponds to the range $r_t$ for the single target.}
\end{figure}
