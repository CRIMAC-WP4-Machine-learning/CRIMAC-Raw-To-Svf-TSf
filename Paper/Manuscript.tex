...
\caption{\label{fi:TS}The discrete fourier transform of the target signal $\ypctargetf(\samplesymf)$ (a) and the reduced auto correlation signal $\ymfautoredf(\samplesymf)$ (b). The normalized discrete Fourier transform of the target signal $\ypctargetnormf(\samplesymf)$ (c) and finally the estimated TS(f) (d).}
\end{figure}
