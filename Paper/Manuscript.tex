...
\caption{\label{Fig_TS_echogram} Sv as a function of ping number and range ($n$) for a calibration sphere. The sphere is located at approximately 6 m range and the seafloor at approximately 12 m. The red vertical line indicates the ping that is used for illustraing the $\ts(\freqsym)$ processing.}
\end{figure}
...
\caption{\label{Fig_Sv_echogram} Sv as a function of ping number and range range ($\samplesymt$) for a echogram raw data file. A fish school is seen between 15 and 35 m range, and the sea flor is seen at approximately 50 m. The red vertical line indicates the ping that is used for illustraing the $\sv(\freqsym)$ processing.}
\end{figure}
